...
% Are we clearly defining what a wire is somewhere? I believe that in the algorithm they are arithmetic expressions.
...
syntactically free of secrets, so no secret is present in the expression of
