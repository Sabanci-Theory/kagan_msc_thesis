...
$\rho \mapsto \mathbf{w}(\rho; \mathbf{a})$ and $\rho \mapsto \mathbf{w}(\rho; \mathbf{b})$. When two
...
in a small scale, a single relabelling of the tape, and couplings of
...
witness of Theorem~\ref{thm:coupling-equiv}.
  ...
  under a fixed secret $\mathbf{a}$ gives a single bijection
