...
\definecolor{hlrand}{HTML}{022831}    % randomness
...
\begin{frame}{The setting}
  ...
  \begin{block}{Inputs are partitioned into three classes}
    \begin{itemize}
      ...
      \item {\color{blue!80}\textbf{publics} $\mathcal{P}$} --- known to
        everyone, held fixed.
    \end{itemize}
  \end{block}
  \medskip
...
\begin{frame}{The probing model}
  ...
  \begin{block}{$d$-probing security}
    An adversary picks any $d$ wires $O = \{w_1, \dots, w_d\}$ and is handed
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{itemize}
        ...
        \item<4-> The context $x_0 \odot y_1$ mentions a share, so the
  ...
  \begin{columns}[c]
    \begin{column}{0.44\textwidth}
      ...
      \only<4>{
        ...
        {\scriptsize a unsafe factor, in yellow}
      }
    \end{column}
    \begin{column}{0.52\textwidth}
      \begin{enumerate}
